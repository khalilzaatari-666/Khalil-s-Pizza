...
import com.vo1d.pizzaapp.adapter.PizzaAdapter;
import com.vo1d.pizzaapp.beans.Produit;
import com.vo1d.pizzaapp.service.ProduitService;

import java.util.ArrayList;
import java.util.List;

public class ListPizzaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create an instance of ProduitService
        ProduitService produitService = new ProduitService();

        // Add pizza items to the service
        // Item 1: BARBECUED CHICKEN PIZZA
        ...
        // Item 2: SPINACH PIZZA
        produitService.create(new Produit("SPINACH PIZZA", 2, R.mipmap.pizza2, "25 min",
        ...
        // Item 3: DEEP-DISH SAUSAGE PIZZA
        produitService.create(new Produit("DEEP-DISH SAUSAGE PIZZA", 8, R.mipmap.pizza3, "45 min",
        ...
        // Item 4: HOMEMADE PIZZA
        produitService.create(new Produit("HOMEMADE PIZZA", 4, R.mipmap.pizza4, "50 min",
        ...
        // Item 6: LOADED MEXICAN PIZZA
        produitService.create(new Produit("LOADED MEXICAN PIZZA", 3, R.mipmap.pizza6, "30 min",
        ...
        // Item 7: BACON CHEESEBURGER PIZZA
        produitService.create(new Produit("BACON CHEESEBURGER PIZZA", 2, R.mipmap.pizza7, "20 min",
                ...
                "STEP 1:\n\nIn a skillet, cook beef and onion over medium heat until meat is no longer pink; drain and set aside.\n\nSTEP 2:\n\nPlace crust on an ungreased 12-inch pizza pan. Spread with pizza sauce. Top with beef mixture, bacon, pickles, and cheeses. Sprinkle with pizza seasoning. Bake at 450° for 8-10 minutes or until cheese is melted."));

        // Item 8: PIZZA MARGHERITA
        produitService.create(new Produit("PIZZA MARGHERITA", 1, R.mipmap.pizza8, "30 min",
        ...
        // Item 9: PEPPERONI-SAUSAGE STUFFED PIZZA
        produitService.create(new Produit("PEPPERONI-SAUSAGE STUFFED PIZZA", 5, R.mipmap.pizza9, "45 min",
                ...
                "STEP 1:\n\nIn a small bowl, dissolve yeast in warm water. In a large bowl, combine oil, salt, sugar, yeast mixture, and 1 cup flour; beat on medium speed until smooth. Stir in enough remaining flour to form a stiff dough.\n\nSTEP 2:\n\nTurn dough onto a floured surface; knead until smooth and elastic, about 6-8 minutes. Place in a greased bowl, turning once to grease the top. Cover with plastic wrap and let rise in a warm place until doubled, about 1 hour.\n\nSTEP 3:\n\nPreheat oven to 425°. Grease a 13x9-inch baking pan. Punch down dough; divide into three portions. On a lightly floured surface, combine two portions of dough and roll into a 15x11-inch rectangle. Transfer to prepared pan, pressing onto the bottom and up the sides of the pan. Top with 2 cups mozzarella cheese and 2 cups cheddar cheese. Sprinkle with flour, seasonings, cooked sausage, mushrooms, and pepperoni.\n\nSTEP 4:\n\nRoll out the remaining dough into a 13x9-inch rectangle. Place dough over the filling, crimping the edges to seal; prick the top with a fork. Sprinkle with the remaining cheeses. Bake on a lower oven rack for 10 minutes.\n\nSTEP 5:\n\nReduce the oven setting to 375°. Spread pizza sauce over the cheese. Bake 30-35 minutes longer or until the edges are lightly browned. Let stand 10 minutes before cutting. If desired, sprinkle with Parmesan cheese. Yield: 12 servings."));
        // Retrieve the list of pizzas from the service
        List<Produit> pizzaList = produitService.findAll();

        // Create a PizzaAdapter and set it to the ListView
        PizzaAdapter pizzaAdapter = new PizzaAdapter(this, pizzaList);
        ListView listViewPizza = findViewById(R.id.listViewPizza);
        listViewPizza.setAdapter(pizzaAdapter);


        listViewPizza.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        @Override
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            // Get the selected pizza item
            Produit selectedPizza = pizzaList.get(position);

            // Create an Intent to start the PizzaDetailActivity
            Intent intent = new Intent(ListPizzaActivity.this, PizzaDetailActivity.class);
            // Pass the selected pizza's data to the PizzaDetailActivity
